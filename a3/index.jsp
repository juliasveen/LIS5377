...
<meta charset="utf-8">
	...
	<meta name="author" content="MJulia Sveen">
	...
	<div class="container">
		<div class="starter-template">
				...
				<br />
					...
					<br /> <br />
					<b>Pet Table</b><br />
					<img src="img/sql_pet.png" class="img-responsive center-block" alt="A3 ERD" />	

					<b>Petstore Table</b><br />
					<img src="img/sql_petstore.png" class="img-responsive center-block" alt="A3 ERD" />	

					<b>Customer Table</b><br />
					<img src="img/sql_customer.png" class="img-responsive center-block" alt="A3 ERD" />	
